...
.text
SETUP:		DrawImageInBothFrames(map, COORDS_MAP)
		DrawImageInBothFrames(key00,COORDS_KEY0)
		DrawImageInBothFrames(key01,COORDS_KEY1)
		DrawImageInBothFrames(porta,COORDS_GATE)
		DrawImageInBothFrames(charDireita,CHAR_POS)
